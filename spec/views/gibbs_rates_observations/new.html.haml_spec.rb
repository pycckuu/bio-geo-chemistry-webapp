...
RSpec.describe "gibbs_rates_observations/new", type: :view do
  before(:each) do
    assign(:gibbs_rates_observation, GibbsRatesObservation.new(
  ...
  pending "renders new gibbs_rates_observation form" do
    render

    assert_select "form[action=?][method=?]", gibbs_rates_observations_path, "post" do
